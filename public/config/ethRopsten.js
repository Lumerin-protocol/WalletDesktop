...
const indexerUrl =
  process.env.ROPSTEN_INDEXER_URL ||
  "https://indexer.metronome.io" ||
  "http://localhost:3005";
const wsApiUrl =
  process.env.ROPSTEN_NODE_URL ||
  "wss://ropsten.infura.io/ws/v3/4b68229d56fe496e899f07c3d41cb08a" ||
  "ws://localhost:8546";
...
module.exports = {
  ...
  // urls
  proxyRouterUrl:
    process.env.PROXY_ROUTER_BASE_URL ||
    "proxyrouter.stg.lumerin.io:8080" ||
    "localhost:8080",
