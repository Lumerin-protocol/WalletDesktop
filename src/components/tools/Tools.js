            ...
            <Tabs style={{ color: 'black' }}>
              ...
              <TabPanel>
                <Sp mt={5}>
                  ...
                  <StyledParagraph>
                    This will set default currency to display prices and
                    balances on Seller Hub.
                ...
                <Sp mt={5}>
                  ...
                  <StyledBtn
                    onClick={() => onActiveModalClick('confirm-rescan')}
                  >
                    Rescan Transactions
                  </StyledBtn>
                  <ConfirmModal
                ...
                <Sp mt={5}>
                  ...
                  <StyledBtn
                    onClick={() => onActiveModalClick('confirm-logout')}
                  >
                    Reset
                  </StyledBtn>
                  ...
                  <ConfirmProxyConfigModal
                    ...
                    message={
                      <>
                        <Message>
                          Make sure you have your recovery phrase before
                          reseting your wallet. If you don’t have your recovery
                          phrase, we suggest you transfer all funds out of your
                          wallet before you reset. Otherwise you will lock
                          yourself out of your wallet, and you won’t have access
                          to the funds in this wallet.
                        </Message>
